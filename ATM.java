...
public class ATM{
    ...
    public static void customerLogin(){
        ...
        details.add("2314");
        details.add("Prathyusha");
        details.add("70000");
        customerDetails.put(1234567891,details);
        ...
        if(customerDetails.containsKey(creditNumber)){
            if(pin == Integer.parseInt(customerDetails.get(creditNumber).get(0))){
                ...
                switch(choice){
                    case 1:checkBalance(creditNumber);
                    break;
                    case 2:withdrawAmount(creditNumber);
                    break;
                    case 3:depositAmount(creditNumber);
                    break;
    ...
    public static void checkBalance(int creditNumber){
        System.out.println("Your current account balance is "+customerDetails.get(creditNumber).get(2));

    }
    public static void withdrawAmount(int creditNumber){
        Scanner sc = new Scanner(System.in);
    ...
    public static void depositAmount(int creditNumber){
        Scanner sc = new Scanner(System.in);
